...
A minimal React + Vite UI that talks to a local OpenAI-compatible model server (e.g. LM Studio, Ollama, llama.cpp) and a small Express tools server. It supports streaming, tool calls, and optional skill loading.
